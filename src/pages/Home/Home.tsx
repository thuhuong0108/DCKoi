        ...
        <Col span={16} offset={4}>
          ...
          <div className="">
            <div className="text-center">
              <h2 className="text-indigo-800 font-bold text-2xl">Initial estimated price</h2>
            </div>
            <div className="mt-4">
              <Select
                size="large"
          ...
          <div className="">
            <div className="text-center">
              <h2 className="text-indigo-800 font-bold text-2xl">Dịch vụ vệ sinh, bảo trì bảo dưỡng hồ cá Koi</h2>
            </div>
